...
client_id = os.getenv("WorkspaceID")
client_secret = os.getenv("AppClientSecret")

luminar_client_id = os.getenv("LuminarAPIClientID")
luminar_client_secret = os.getenv("LuminarAPIClientSecret")
luminar_account_id = os.getenv("LuminarAPIAccountID")
